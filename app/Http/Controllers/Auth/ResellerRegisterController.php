...
class ResellerRegisterController extends Controller
{
    ...
    public function register(Request $request)
    {
        $data = $request->validate([
            ...
            'screenshots.required' => 'Please upload at least 1 screenshot of your traffic statistics.',
        ...
        // Same supporting rows as publishers — dividers, fraud settings, etc. all key on these
        ...
        try {
            ...
            \Log::error('Reseller verification email failed: ' . $e->getMessage());
        }
