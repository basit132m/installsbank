...
<div style="display:grid;grid-template-columns:1fr 300px;gap:20px;align-items:start;">
    ...
    <div style="display:flex;flex-direction:column;gap:14px;">
        ...
        <div class="card" style="padding:18px;">
            ...
            <form method="POST" action="{{ route('admin.email-replies.destroy', $emailReply) }}" style="margin-top:10px;"
                  onsubmit="return confirm('Delete this email? This cannot be undone.')">
                @csrf
                @method('DELETE')
                <button type="submit"
                        style="width:100%;display:flex;align-items:center;justify-content:center;gap:8px;background:#fff;border:1px solid #fca5a5;color:#ef4444;border-radius:8px;padding:10px 16px;font-size:13px;font-weight:600;cursor:pointer;">
                    <svg width="14" height="14" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
