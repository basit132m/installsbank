...
<body>
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            @php $showTools = auth()->user()->hasPermission('can_generate_reports') || auth()->user()->hasPermission('can_manage_dashboards'); @endphp
            @if($showTools)
            <div class="nav-section-title">Tools</div>
            @if(auth()->user()->hasPermission('can_generate_reports'))
            <a href="{{ route('admin.traffic-reports.index') }}" class="nav-item {{ request()->routeIs('admin.traffic-reports.*') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                Traffic Reports
            </a>
            @endif
            @if(auth()->user()->hasPermission('can_manage_dashboards'))
            <a href="{{ route('admin.portal-accounts.index') }}" class="nav-item {{ request()->routeIs('admin.portal-accounts.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.clicks-cleanup.index') }}" class="nav-item {{ request()->routeIs('admin.clicks-cleanup.*') ? 'active' : '' }}">
            ...
            <a href="{{ route('admin.traffic-tiers.index') }}" class="nav-item {{ request()->routeIs('admin.traffic-tiers.*') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4h13M3 8h9m-9 4h9m5-4v12m0 0l-4-4m4 4l4-4"/></svg>
                Traffic Tiers
            </a>
            ...
            <a href="{{ route('admin.mac-rates.index') }}" class="nav-item {{ request()->routeIs('admin.mac-rates.*') ? 'active' : '' }}">
