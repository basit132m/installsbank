...
<body>
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            @if($approved)
            <a href="{{ route('reseller.overview') }}" class="nav-item {{ request()->routeIs('reseller.overview') ? 'active' : '' }}">
                <svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3v18h18M9 17V9m4 8V5m4 12v-6"/></svg>
                Websites Overview
            </a>
